...
<body>
	...
	<div class="container">
		<div class="row">
			<div class="jumbotron">
				<p>{{mensaje}}</p><!--este campo sirve para indicar que se envio un campo vacio-->
				<form action="/register" method="post">
				Usuario: <input name="username" type="text" /><p></p>
				Clave: &nbsp;&nbsp;&nbsp;<input name="password" type="password" /><p></p>
				Correo: &nbsp;<input name="email" type="text" /><p></p>
